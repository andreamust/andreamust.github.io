...
// configure
$from = 'andrea.poltronieri21@gmail.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'andrea.poltronieri2@unibo.it'; // Replace it with Your email. REQUIRED!
